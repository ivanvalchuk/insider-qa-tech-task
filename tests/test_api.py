...
@mark.api
@allure.title("4. Find a created pet by ID and GET a non-existing pet")
...
@mark.api
@allure.title("5. Create a list of users with the given input array and test the same with an error in the body")
...
@mark.api
@allure.title("6. Place an order for a pet and test the same with an error in the body")
@mark.parametrize("request_body, status_code", [
